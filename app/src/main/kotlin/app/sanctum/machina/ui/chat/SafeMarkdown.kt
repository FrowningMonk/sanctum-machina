...
// D25 — markdown link-scheme whitelist. LLM-rendered markdown may contain
// `[text](intent://...)`, `[text](sms:...)`, `[text](tel:...)` etc. that could
// launch unwanted intents. Only http/https are forwarded.
...
fun SafeMarkdown(
    ...
    val safeHandler = remember(context) { SafeUriHandler(context) }
    val fontSize =
