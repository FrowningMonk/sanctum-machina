...
2. **Verify choices** against current docs via WebFetch/WebSearch. Update if you find deprecations or better alternatives.
...
2. **Verify** against current docs via WebFetch/WebSearch
