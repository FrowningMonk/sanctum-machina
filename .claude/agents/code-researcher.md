...
4. If external libraries are involved — use WebFetch/WebSearch to consult current docs for best practices and API patterns.
...
9. **External Libraries** — if applicable, use WebFetch/WebSearch to research APIs, best practices, configuration. Document key APIs the feature will use.
